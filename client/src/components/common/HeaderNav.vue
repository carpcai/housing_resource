    ...
    <header class="top-nav-container">
      <nav class="top-nav">
        <a v-link="{ path: '/posts', activeClass: 'active' }" class="vertical-center nav-logo">
          ...
          <span class="brand vertical-center-content">理工房源推荐网</span>
        </a>
        <ul class="nav-link-container">
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/posts', activeClass: 'active' }" >房源</a></li>
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/tags', activeClass: 'active' }">分类</a></li>
          ...
          <li class="nav-link-item"><a class="nav-link" v-link="{ path: '/map', activeClass: 'active' }">地图</a></li>
        </ul>
    ...
    <div class="nav-mask" :class="[asideNavShow? 'open':'']" @click="asideNavShow = false">
      <aside class="nav-aside" >
        <ul class="nav-aside-list">
          <li ><a class="nav-link" v-link="{ path: '/posts', activeClass: 'active' }" >房源</a></li>
          <li ><a class="nav-link" v-link="{ path: '/tags', activeClass: 'active' }">分类</a></li>
          ...
          <li ><a class="nav-link" v-link="{ path: '/map', activeClass: 'active' }">地图</a></li>
        </ul>
      </aside>
    </div>
